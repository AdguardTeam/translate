...
const getPluralFormId = (locale: Locales, number: number): number => {
    ...
    const supportedForms: Record<AvailableLocales, number> = {
        ...
        [AvailableLocales.zh_tw]: 1,
        [AvailableLocales.zh_cn]: 1,
        ...
        [AvailableLocales.pt_pt]: (number === 1) ? 1 : 2,
        [AvailableLocales.pt_br]: (number === 1) ? 1 : 2,
        ...
        [AvailableLocales.fr]: ((number === 0) || (number >= 2)) ? 2 : 1,
        // AG-26130
        [AvailableLocales.tr]: ((number === 0) || (number >= 2)) ? 2 : 1,
...
const pluralFormsCount: Record<AvailableLocales, number> = {
    ...
    [AvailableLocales.tr]: 3,
    [AvailableLocales.vi]: 2,
    [AvailableLocales.zh]: 2,
    [AvailableLocales.zh_cn]: 2,
    [AvailableLocales.zh_tw]: 2,
    ...
    [AvailableLocales.pt_pt]: 3,
    [AvailableLocales.pt_br]: 3,
